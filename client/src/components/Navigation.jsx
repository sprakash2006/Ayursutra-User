...
import webLogo from '/src/assets/images/web_logo.png';
...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-b border-orange-200/50 shadow-lg">
